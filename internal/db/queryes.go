...
const (
	...
	insertURLInfo = "INSERT INTO urls_info (url_id, user_browser, user_browser_version, user_model, user_platform, user_os, user_ip, user_short_url, user_bot, user_mobile) VALUES ($1, $2, $3, $4, $5)"
	...
	insertUser = "INSERT INTO users (login, password, name) VALUES ($1, $2, $3)"
	// Запрос для проверки логина и пароля (авторизация).
	checkUserCredentials = "SELECT COUNT(*) FROM users WHERE login = $1 AND password = $2"
)
